...
async def client_get_updates(
    ...
    Returns:
        TelegramResponse containing list of messages sent by the bot.
    """
    ...
    # Filter to only bot messages and extract raw messages
    bot_messages = [msg.raw_message for msg in stored_messages if msg.is_bot_message]

    return TelegramResponse(ok=True, result=bot_messages)
